...
<body>
    ...
    <main id="main">
        ...
        <section id="mainContent">
            ...
            <div class="container">
                <article class="content-swiper s1 active">
                ...
                <!-- article -->
                <article class="content-swiper s2">
                    <span class="swiper-wrap">
                ...
                <article class="content-festival">
                    <div class="festival-wrap">
                        ...
                        <div class="festival">
                            <img src="../assets/img/festival1.jpg" alt="페스티벌1" class="festival-img">
                        ...
                        <div class="festival">
                            <img src="../assets/img/festival3.jpg" alt="페스티벌3" class="festival-img">
                            <div class="festival-sub">
